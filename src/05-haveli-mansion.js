...
export class HaveliSecurity {
  ...
  addResident(name, role, passcode) {
    ...
    const isExist = this.#residents.some((elem) => {
  ...
  removeResident(name, passcode) {
    ...
    const idx = this.#residents.findIndex((elem) => {
      return elem.name === name;
    });
  ...
  verifyAccess(name) {
    // Your code here
    const guest = this.#residents.find((elem) => {
      return elem.name === name;
    });
  ...
  getAccessLog(passcode) {
    ...
    return this.#accessLog.map((elem) => {
      return { ...elem };
    });
  }
  ...
  isResident(name) {
    // Your code here
    return this.#residents.some((elem) => {
      return elem.name === name;
    });
  }
}
